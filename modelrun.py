...
#        self.ofile.create_group(run_id)
        ...
        print ' '
        state_out,infodict=odeint(self.deriv_mod,self.INIT,self.time,full_output=1, printmessg=True, args=(self.rain_int,self.evapo_int,self.PARS,self.OPTIONS),hmax=1.0)
